	...
	theme: {
		...
		extend: {
			colors: {
				...
				// DevChat specific colors
				'dev-purple': 'hsl(var(--dev-purple))',
				'dev-purple-dark': 'hsl(var(--dev-purple-dark))',
				'dev-green': 'hsl(var(--dev-green))',
				'dev-orange': 'hsl(var(--dev-orange))',
				'dev-red': 'hsl(var(--dev-red))',
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { boxShadow: '0 0 20px hsl(var(--dev-purple) / 0.3)' },
					'50%': { boxShadow: '0 0 30px hsl(var(--dev-purple) / 0.6)' }
				},
				'float': {
